...
internal val CATEGORY_APP_KEYWORDS: Map<SupportedLocale, Map<CategoryPool, String>> = mapOf(
    ...
    SupportedLocale.ZH to mapOf(
        CategoryPool.MEDICAL to "健康+医疗",
        CategoryPool.LEGAL to "法律+咨询",
        CategoryPool.AUTOMOTIVE to "汽车+维修+保养",
        CategoryPool.PARENTING to "育儿+亲子+宝宝",
        CategoryPool.RETIREMENT to "养老+退休+规划",
        CategoryPool.GAMING to "游戏+策略",
        CategoryPool.AGRICULTURE to "农业+种植",
        CategoryPool.FASHION to "时尚+穿搭+风格",
        CategoryPool.ACADEMIC to "学习+备考+教育",
        CategoryPool.REAL_ESTATE to "房产+租房+买房",
        CategoryPool.COOKING to "菜谱+美食+烹饪",
        CategoryPool.SPORTS to "体育+赛事+比分",
        CategoryPool.FINANCE to "理财+记账+金融",
        CategoryPool.TRAVEL to "旅行+攻略+酒店",
        CategoryPool.TECHNOLOGY to "科技+数码+新闻",
        CategoryPool.PETS to "宠物+狗+猫+养护",
        CategoryPool.HOME_IMPROVEMENT to "家居+装修+DIY",
        CategoryPool.BEAUTY to "美妆+护肤+教程",
        CategoryPool.MUSIC to "音乐+播客+电台",
        CategoryPool.FITNESS to "健身+运动+跑步",
        CategoryPool.ENTERTAINMENT to "影视+综艺+娱乐",
        CategoryPool.FOOD to "外卖+美食+餐厅",
        CategoryPool.POLITICS to "新闻+时政+热点",
        CategoryPool.SCIENCE to "科学+科普+探索",
        CategoryPool.BUSINESS to "商务+办公+效率",
        CategoryPool.OUTDOOR_RECREATION to "户外+徒步+露营",
        CategoryPool.CRAFTS to "手工+创意+DIY",
        CategoryPool.HISTORY to "历史+人文+博物馆",
        CategoryPool.ENVIRONMENT to "环保+低碳+可持续",
        CategoryPool.MILITARY_DEFENSE to "军事+国防+退伍",
        CategoryPool.WELLNESS_ALTERNATIVE to "冥想+星座+养生",
        CategoryPool.RELATIONSHIPS_DATING to "交友+恋爱+情感"
    )
)
